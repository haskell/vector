...
-- >>> deriving via (Bar a `VU.As` (Int, VU.DoNotUnboxStrict a)) instance NFData a => M.MVector VUM.MVector (Bar a)
-- >>> deriving via (Bar a `VU.As` (Int, VU.DoNotUnboxStrict a)) instance NFData a => VG.Vector   VU.Vector   (Bar a)
-- >>> instance NFData a => VU.Unbox (Bar a)
-- >>> :}
--
...
-- >>> deriving via (Baz a `VU.As` (Int, VU.DoNotUnboxNormalForm a)) instance NF.NFData a => M.MVector VUM.MVector (Baz a)
