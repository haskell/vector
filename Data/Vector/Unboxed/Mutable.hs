...
takeEnd :: Unbox a => Int -> MVector s a -> MVector s a
{-# INLINE takeEnd #-}
takeEnd = G.takeEnd
...
dropEnd :: Unbox a => Int -> MVector s a -> MVector s a
{-# INLINE dropEnd #-}
dropEnd = G.dropEnd
...
unsafeTakeEnd :: Unbox a => Int -> MVector s a -> MVector s a
...
unsafeDropEnd :: Unbox a => Int -> MVector s a -> MVector s a
